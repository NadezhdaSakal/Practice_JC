public class Battle {
    ...
    public void fight(Character hero, Character monster, Play.FightCallback fightCallback) {
        Runnable runnable = () -> {
            int turn = 1;
    ...
    private Boolean makeHit(Character defender, Character attacker, Play.FightCallback fightCallback) {
